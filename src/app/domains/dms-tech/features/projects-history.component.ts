        ...
        <div class="card">
            <p-toolbar styleClass="mb-4">
                <ng-template pTemplate="left">
                    <h2 class="m-0">
                        <i class="pi pi-history mr-2"></i>Projects History
                    </h2>
                </ng-template>
                ...
                *ngIf="!timelineView"
                ...
                <ng-template pTemplate="header">
                    <tr>
                        ...
                        <th pSortableColumn="project_name">
                            Project Name <p-sortIcon field="project_name"></p-sortIcon>
                        </th>
                ...
                <ng-template pTemplate="body" let-record>
                    <tr>
                        ...
                        <td>
                            <strong class="text-primary">{{ record.project_name }}</strong>
                        </td>
                        <td>
                            <p-tag
                        ...
                        <p-card [styleClass]="'timeline-card ' + event.change_type + '-card'">
                            <ng-template pTemplate="header">
                                <div class="timeline-card-header">
                                    ...
                                    <strong class="text-primary ml-2">{{ event.project_name }}</strong>
                                </div>
                            </ng-template>
...
export class ProjectsHistoryComponent implements OnInit {
    ...
    loadData(): void {
        ...
        forkJoin({
            history: this.productionService.getProjectHistory(),
            users: this.productionService.getProjectHistoryUsers()
        }).subscribe({
            next: (data: any) => {
    ...
    groupHistoryForTimeline(history: ProjectHistory[]): ProjectHistory[] {
    ...
    exportToCSV(): void {
        ...
        // Prepare CSV content
        const headers = ['Date/Time', 'Project Name', 'Action', 'Field', 'Old Value', 'New Value', 'User'];
        ...
        link.setAttribute('download', `projects_history_${new Date().toISOString().slice(0, 10)}.csv`);
